namespace VIEWS
{
	partial class frmCadastrarUsuario
	{
		...
		private void InitializeComponent()
		{
			...
			lblTitle.TabIndex = 0;
			lblTitle.Text = "Cadastrar Usuário";
			...
			txtNome.PlaceholderText = "Digite o nome de usuário";
			...
			tbButton.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
			tbButton.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
			tbButton.Controls.Add(btnCadastrar, 1, 0);
			...
			btnCadastrar.Location = new Point(106, 3);
